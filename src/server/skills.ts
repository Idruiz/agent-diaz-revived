...
export const skills:AgentSkill[]=[
 ...
 {id:"deep-research",kind:"research",name:"Deep Research Report",description:"Research current evidence and deliver a cited visual Word report.",tools:["web_search"],artifact:"docx",minVisuals:2,approvalPolicy:"read_only",validation:["Material claims are cited","Sources are real URLs","At least two evidence-driven visuals"],instructions:"Search iteratively until the core claims are supported. Resolve conflicts. Produce a finished report with evidence tables and charts when the sources contain quantitative data."},
 ...
 {id:"visual-presentation",kind:"presentation",name:"Visual Presentation",description:"Create a sourced PowerPoint with charts, tables, diagrams, notes and real-image briefs.",tools:["web_search"],artifact:"pptx",minVisuals:3,approvalPolicy:"read_only",validation:["Slide content is finished","Visuals serve the argument","Sources resolve","Speaker notes are useful"],instructions:"Plan a visual narrative, not a document chopped into slides. Mix concise text with evidence charts, exact tables, process diagrams, and real-photo search briefs."},
 {id:"professional-document",kind:"document",name:"Professional Document",description:"Create a structured, sourced and visual Word document.",tools:["web_search"],artifact:"docx",minVisuals:2,approvalPolicy:"read_only",validation:["Heading hierarchy is coherent","Tables and charts are evidence-based","Sources resolve"],instructions:"Write finished prose with a coherent hierarchy. Use exact tables, evidence charts, and diagrams where they clarify the argument."},
