...
export const skills:AgentSkill[]=[
 ...
 {id:"visual-presentation",kind:"presentation",name:"Visual Presentation",description:"Create a sourced PowerPoint with varied layouts, editable charts, diagrams, notes and licensed imagery.",tools:["web_search"],artifact:"pptx",minVisuals:5,approvalPolicy:"read_only",validation:["Slide content is finished","At least half of content slides are genuinely visual","At least three slides use relevant licensed photography or explanatory illustration","Charts contain sourced data","Sources resolve","Speaker notes are useful"],instructions:"Plan a visual narrative, not a document chopped into slides. Give each slide one job. Use concise audience-facing copy, varied silhouettes, specific licensed-image search briefs, editable evidence charts, exact tables, and at most the diagrams the story genuinely needs."},
